...
Open the differential_expression_analysis.R script in RStudio.
Set your working directory to the project folder, e.g., setwd("/path/to/your_project/").
Source the script or run it line by line to perform the analysis.
View Results:
